    ...
    <aside className="w-64 bg-slate-950 text-slate-300 flex flex-col h-full border-r border-slate-800/80 shadow-md select-none z-20">
      ...
      <div className="p-3.5 border-b border-slate-800/80 flex justify-between items-center bg-slate-900/40">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-semibold text-xs text-slate-100 uppercase tracking-wider">
            Explorador
          </h2>
        </div>
        <button 
      ...
      <div className="p-3 flex flex-col gap-3 flex-1 overflow-y-auto">
        ...
        <button 
          ...
          className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white py-2 px-3 rounded-lg text-xs font-semibold shadow-sm shadow-blue-500/20 transition-all active:scale-98 cursor-pointer"
        >
          <FolderPlus size={15} />
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-slate-900 border border-slate-800 text-slate-200 placeholder:text-slate-500 focus:border-blue-500 rounded-lg pl-8 pr-2.5 py-1.5 text-xs focus:outline-none transition-colors"
          />
        </div>
        ...
        <div className="flex flex-col gap-1 mt-1">
          ...
          {loading ? (
            ...
            <div className="p-4 text-center text-xs border border-dashed border-slate-800 text-slate-500 rounded-lg">
            ...
            filteredProjects.map(proj => {
              ...
              return (
                <button 
                  ...
                  className={`w-full flex items-start gap-2.5 px-2.5 py-2 rounded-lg text-xs text-left transition-all cursor-pointer ${
                    isSelected 
